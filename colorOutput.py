...
print(f"{Fore.LIGHTRED_EX}LIGHT Red Text")
print(f"{Fore.GREEN}Green Text")
print(f"{Fore.LIGHTGREEN_EX}LIGHT Green Text")
print(f"{Fore.YELLOW}Yellow Text")
print(f"{Fore.LIGHTYELLOW_EX}LIGHTYellow Text")
print(f"{Fore.BLUE}Blue Text")
print(f"{Fore.LIGHTBLUE_EX}LIGHTBlue Text")
print(f"{Fore.MAGENTA}Magenta Text")
print(f"{Fore.LIGHTMAGENTA_EX}LIGHT Magenta Text")
print(f"{Fore.CYAN}Cyan Text")
print(f"{Fore.LIGHTCYAN_EX}LIGHT Cyan Text")
print(f"{Fore.WHITE}White Text")
print(f"{Fore.LIGHTWHITE_EX}LIGHT White Text")
print()
